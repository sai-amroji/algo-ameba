    ...
    >
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center mr-4 ml-2">
            ...
            <img
              src="/Ameba.svg"
              alt="Logo"
              className="w-10 h-10 absolute mr-4"
            />
          </div>
          <span className="font-[audiowide] text-lg font-semibold tracking-wide">
            AlgoAmeba
          </span>
        </div>
      ...
      >
        ...
        >
          ...
          <div
            ref={arrowRef}
            className="absolute bottom-44 left-[14%] opacity-50"
          >
          ...
          <div
            className="absolute bottom-1/4 left-1/3 w-48 h-48 rounded-full bg-cyan-500/5 blur-3xl animate-pulse"
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          >
            ...
            Learn sorting, searching, and data structures by seeing them
            breathe.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Built for learners who want to understand algorithms, not just
              memorize them.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="feature-card p-6 rounded-2xl bg-card border border-border/50 hover:border-brand/30 transition-all hover:shadow-lg hover:shadow-brand/10">
              ...
              <p className="text-muted-foreground">
                Control animations frame by frame. Pause, rewind, and speed up
            ...
            <div className="feature-card p-6 rounded-2xl bg-card border border-border/50 hover:border-brand/30 transition-all hover:shadow-lg hover:shadow-brand/10">
              ...
              <p className="text-muted-foreground">
                From bubble sort to binary trees, explore sorting, searching,
                and data structures all in one place.
              </p>
            </div>
            ...
            <div className="feature-card p-6 rounded-2xl bg-card border border-border/50 hover:border-brand/30 transition-all hover:shadow-lg hover:shadow-brand/10">
              ...
              <p className="text-muted-foreground">
                Powered by GSAP for silky-smooth 60fps animations that make
                complex concepts intuitive.
              </p>
            </div>
            ...
            <div className="feature-card p-6 rounded-2xl bg-card border border-border/50 hover:border-brand/30 transition-all hover:shadow-lg hover:shadow-brand/10">
              ...
              <p className="text-muted-foreground">
                Enter your own values or generate random arrays. Test edge cases
            ...
            <div className="feature-card p-6 rounded-2xl bg-card border border-border/50 hover:border-brand/30 transition-all hover:shadow-lg hover:shadow-brand/10">
              ...
              <p className="text-muted-foreground">
                Works seamlessly on desktop, tablet, and mobile. Learn anywhere,
                anytime.
              </p>
            </div>
            ...
            <div className="feature-card p-6 rounded-2xl bg-card border border-border/50 hover:border-brand/30 transition-all hover:shadow-lg hover:shadow-brand/10">
              ...
              <p className="text-muted-foreground">
                Open source and completely free forever. No subscriptions, no
                paywalls, just learning.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Watch bubble, quick, merge, and insertion sort come to life
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  See linear and binary search in action with range highlighting
                  and found markers.
                </p>
                <div className="flex gap-2 flex-wrap">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Explore trees, graphs, stacks, queues, heaps, and linked lists
                  visually.
                </p>
                <div className="flex gap-2 flex-wrap">
                  <span className="px-3 py-1 text-xs rounded-full bg-violet-500/20 text-violet-400">
                    Trees
                  </span>
                  <span className="px-3 py-1 text-xs rounded-full bg-violet-500/20 text-violet-400">
                    Graphs
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="step-content pt-2">
                ...
                <p className="text-muted-foreground">
                  Browse our collection of sorting, searching, and data
                  structure algorithms. Pick the one you want to learn about.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="step-content pt-2">
                ...
                <p className="text-muted-foreground">
                  Type in your own values or generate random data. Test
                  different scenarios to understand how algorithms behave.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="step-content pt-2">
                ...
                <p className="text-muted-foreground">
                  Play the animation and watch step-by-step as the algorithm
                  works. Use controls to pause, skip, and adjust speed.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-3xl bg-gradient-to-br from-brand/10 via-emerald-500/10 to-cyan-500/10 border border-brand/30">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
              Join thousands of learners who understand algorithms through
              visualization.
            </p>
            <button
              onClick={() => navigate(ROUTES.home)}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-[audiowide] text-lg font-semibold">
                AlgoAmeba
              </span>
            </div>
