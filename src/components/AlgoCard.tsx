...
const AlgoCard = ({ algoImg, algoName,algoRoute }: AlgoProps) => {
  ...
  return (
    <div
      ...
      className="bg-white rounded-2xl px-6 pt-6 w-full max-w-[440px] h-[360px] transition-all duration-300 z-10 shadow-[8px_8px_rgb(0,0,0,0.45)] cursor-pointer overflow-hidden backdrop-blur-[15px]"
    >
      <img
        src={algoImg}
        alt={algoName}
