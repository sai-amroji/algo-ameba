  ...
  return (
    ...
    <div className="w-full h-full ">
      ...
      <div className="flex gap-2 mb-4 m-2 flex-wrap">
        <div >
          <input placeholder="Enter Number" className="border-2 h-[40px] text-black p-2 rounded-xl border-black"/>
          <button className="text-center ml-2 border-2 border-green-800  bg-green-400 h-[40px] p-2  rounded-xl">
            Enter Number
          </button>
        </div>
        <div className="">
          <button className="text-center ml-2 border-2 border-purple-800  bg-purple-400 h-[40px] p-2  rounded-xl">
            Insert
          </button>
          <button className="text-center ml-2 border-2 border-orange-800  bg-orange-400 h-[40px] p-2  rounded-xl">
            Delete
          </button>
          <button className="text-center ml-2 border-2 border-violet-800  bg-violet-400 h-[40px] p-2  rounded-xl">
            Search
          </button>
        </div>
        {MODES.map(m => (
